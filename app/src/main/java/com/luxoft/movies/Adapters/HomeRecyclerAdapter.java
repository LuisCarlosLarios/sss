...
import com.luxoft.movies.R;
import com.luxoft.movies.models.SearchArrayObject;
...
public class HomeRecyclerAdapter extends RecyclerView.Adapter<HomeViewHolder>{
    ...
    public HomeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new HomeViewHolder(LayoutInflater.from(context).inflate(R.layout.home_movies_lista, parent, false));
    }
